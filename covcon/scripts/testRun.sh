...
run_script "$benchmarkDirParent/Day/" "Day" 3 $reportFile
...
#run_script "$benchmarkDirParent/XYPlot/" "XYPlot" 1 $reportFile
#run_script "$benchmarkDirParent/Logger/" "Logger" 1 $reportFile
run_script "$benchmarkDirParent/SynchronizedMap/" "SynchronizedMap" 3 $reportFile
#run_script "$benchmarkDirParent/ConcurrentHashMap/" "ConcurrentHashMap" 15 $reportFile
run_script "$benchmarkDirParent/StringBuffer/" "StringBuffer" 3 $reportFile
